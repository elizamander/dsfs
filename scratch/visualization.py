...
# plt.show()
# uncomment the above to make the plot show up in a new window

plt.savefig('im/viz_gdp.png')   # saves the generated figure to the path specified
plt.gca().clear()               # clears the plot data for the next plot in this code
...
histogram = Counter(min(grade // 10 * 5, 90) for grade in grades)
...
plt.xticks([10 * i for i in range(11)])    # x-axis labels at 0, 10, ..., 100
                                           # lazy generated instead of manually listing each ten
plt.xlabel("Decile")
